...
//CllocationManager を使う ために上記のように　delegate を指定する
...
- (void) viewDidLoad {
    ...
    //CLLocationManagerはviewDidLoad内で初期化され、位置情報の取得を開始する
    ...
    self.mapView.mapType = MKMapTypeHybridFlyover; //mapType で　航空写真などに変更
...
- (IBAction)exitFromDataView:(UIStoryboardSegue *)segue {
    //MapViewContoroller に遷移する　戻ってくる
}
